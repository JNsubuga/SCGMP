...
class GoodSamaritans:
    ...
    def getAllGoodSamaritans(self, request, lang):
        results = []
        goodSamaritans = GoodSamaritan.objects.filter(is_disabled=False).order_by("id")
    ...
    def updateGoodSamaritan(self, request, lang, data, goodSamaritanid):
        ...
        updateRecord_dic = {
            ...
            "phoneNumber": data["phoneNumber"] if data["phoneNumber"] else dbRecToUpdate.phoneNumber,
            "BirthDate": data["BirthDate"] if data["BirthDate"] else dbRecToUpdate.BirthDate,
            "placeOfResidence": data["placeOfResidence"] if data["placeOfResidence"] else dbRecToUpdate.placeOfResidence,
            "timeOfStay": data["timeOfStay"] if data["timeOfStay"] else dbRecToUpdate.timeOfStay,
            "hasDependants": data["hasDependants"] if data["hasDependants"] else dbRecToUpdate.hasDependants,
            "numberOfDependants": data["numberOfDependants"] if data["numberOfDependants"] else dbRecToUpdate.numberOfDependants,
            "hasNationalID": data["hasNationalID"] if data["hasNationalID"] else dbRecToUpdate.hasNationalID,
            "NIN": data["NIN"] if data["NIN"] else dbRecToUpdate.NIN,
            "youthHoodBusiness": data["youthHoodBusiness"] if data["youthHoodBusiness"] else dbRecToUpdate.youthHoodBusiness,
            "getsGrant": data["getsGrant"] if data["getsGrant"] else dbRecToUpdate.getsGrant,
            "forHowLong": data["forHowLong"] if data["forHowLong"] else dbRecToUpdate.forHowLong,
            "howMuch": data["howMuch"] if data["howMuch"] else dbRecToUpdate.howMuch,
            "howItHelpedYou": data["howItHelpedYou"] if data["howItHelpedYou"] else dbRecToUpdate.howItHelpedYou,
            "BenefitsFromGoodSamaritan": data["BenefitsFromGoodSamaritan"] if data["BenefitsFromGoodSamaritan"] else dbRecToUpdate.BenefitsFromGoodSamaritan,
            "grant": data["grant"] if data["grant"] else dbRecToUpdate.grant,
            "howDoYouSurvive": data["howDoYouSurvive"] if data["howDoYouSurvive"] else dbRecToUpdate.howDoYouSurvive,
            "placeOfWorship": data["placeOfWorship"] if data["placeOfWorship"] else dbRecToUpdate.placeOfWorship,
            "yourNeedFromGovtAsAGrand": data["yourNeedFromGovtAsAGrand"] if data["yourNeedFromGovtAsAGrand"] else dbRecToUpdate.yourNeedFromGovtAsAGrand,
            "adviseToTheYouth": data["adviseToTheYouth"] if data["adviseToTheYouth"] else dbRecToUpdate.adviseToTheYouth,
